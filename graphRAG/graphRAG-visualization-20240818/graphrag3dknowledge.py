...
def visualize_graph_plotly(G):
    ...
    fig = make_subplots(
        ...
        subplot_titles=("3D Knowledge Graph Web Render", "Node Degree Distribution", "Degree Centrality Distribution")
    )
...
def main():
    """ 功能：主函数，协调整个程序的执行流程
        实现：
            ...
            调用可视化函数
    """
    directory = '/Users/huqianghui/Downloads/graphRAG-OpenWebUI/ragtest/output/20240816-141019/artifacts'  # 替换为实际的目录路径
